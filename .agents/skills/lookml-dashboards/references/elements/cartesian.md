...
| :--- | :--- | :--- | :--- |
| `cluster_points` | `boolean (true/false)` | `Cluster Points` | Toggle to group or cluster data points in a scatter chart visualization |
| `color_application.options.reverse` | `boolean (true/false)` | `Reverse colors` | Toggle to reverse the order of colors in the selected categorical palette |
...
| `discontinuous_nulls` | `boolean (true/false)` | `Display Null Values as Discontinuities` | Display null values as discontinuities in line/area charts |
...
| `hide_legend` | `boolean (true/false)` | `Hide Legend` | Toggle option to hide chart legend |
...
| `quadrants_enabled` | `boolean (true/false)` | `Plot Quadrants` | Toggle option to show quadrants in scatter chart |
...
| `show_dropoff` | `boolean (true/false)` | `Show Percent of Previous` | Display arrows showing percent change from previous value |
| `show_null_labels` | `boolean (true/false)` | `Label Null Values` | Show value labels for null data points |
| `show_null_points` | `boolean (true/false)` | `Plot Null Values` | Plot null values in a graph visualization |
| `show_silhouette` | `boolean (true/false)` | `Show Silhouette` | Display a grey silhouette for series disabled in legend |
| `show_totals_labels` | `boolean (true/false)` | `Totals Labels` | Show or hide labels for the totals of stacked series |
| `show_value_labels` | `boolean (true/false)` | `Label Values` | Show value labels for each data point |
| `show_view_names` | `boolean (true/false)` | `Show Full Field Name` | Toggle to show full field name in tooltip |
| `show_x_axis_label` | `boolean (true/false)` | `Show Axis Name` | Toggle to show the X axis name |
| `show_x_axis_ticks` | `boolean (true/false)` | `Show Axis Value Labels` | Toggle to show X axis value labels (ticks) |
| `show_y_axis_labels` | `boolean (true/false)` | `Show Y Axis Name` | Toggle option to show or hide title label of Y axis |
| `show_y_axis_ticks` | `boolean (true/false)` | `Show Y Axis Value Labels` | Toggle option to show or hide tick values along Y axis |
| `stacking` | `string (one of: '', 'normal', 'percent')` | `Series Positioning` | Stacking style for bar/column/area charts |
| `swap_axes` | `boolean (true/false)` | `Swap X and Y Axis` | Toggle to swap X and Y axis |
...
| `trend_lines.[i].show_label` | `boolean (true/false)` | `Show Label` | Toggle to show trend line label |
...
| `x_axis_gridlines` | `boolean (true/false)` | `Show Gridlines` | Toggle to show X axis gridlines |
| `x_axis_label` | `string` | `Custom Axis Name` | Custom text name for X axis |
| `x_axis_reversed` | `boolean (true/false)` | `Reverse Axis` | Toggle direction of X axis |
| `x_axis_scale` | `string (one of: 'auto', 'ordinal', 'time')` | `Scale Type` | Scale type for X axis |
| `x_axis_zoom` | `boolean (true/false)` | `Allow Zoom` | Enable zoom to magnify a portion of the chart |
...
| `y_axes.[i].showLabels` | `boolean (true/false)` | `Show Axis Name` | Toggle to show Y axis name |
| `y_axes.[i].showValues` | `boolean (true/false)` | `Show Axis Value Labels` | Toggle to show Y axis tick values |
...
| `y_axes.[i].unpinAxis` | `boolean (true/false)` | `Unpin Axis` | Unpin axis from starting at zero |
| `y_axes.[i].valueFormat` | `string` | `Y Axis Format` | Format string for Y axis tick labels |
| `y_axis_gridlines` | `boolean (true/false)` | `Show Gridlines` | Toggle to show Y axis gridlines |
| `y_axis_reversed` | `boolean (true/false)` | `Reverse Axes` | Toggle direction of Y axis |
...
| `y_axis_zoom` | `boolean (true/false)` | `Allow Zoom` | Enable zoom to magnify a portion of chart |
